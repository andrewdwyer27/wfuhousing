        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-4">
              <p className="text-gray-800 mb-2">Your selection time: <span className="font-semibold text-yellow-800">April 3, 2025 at 10:00 AM</span></p>
              <p className="text-gray-700 text-sm">You must select your room during your assigned time slot. If you miss your time slot, you can still select from remaining rooms afterward.</p>
            </div>
            
            <p className="text-sm text-gray-600 flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 flex-shrink-0 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Selection priority is based on class year and housing points. Your housing points: <span className="font-semibold">35</span>
            </p>
          </div>
