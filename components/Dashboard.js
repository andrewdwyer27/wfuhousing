                    ...
                    <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                        ...
                        {user?.selectedRoom ? (
                            <div className="bg-green-50 border border-green-200 rounded-md p-4">
                                <p className="text-green-800 font-medium mb-2">You have selected a room:</p>
                                <div className="flex items-center text-green-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                                    </svg>
                                    <span className="font-semibold">{user.selectedRoom.roomNumber} in {user.selectedRoom.dormName}</span>
                                </div>
                            </div>
                        ) : (
                        ...
                        {/* Roommate Status Section */}
                        <h3 className="text-lg font-semibold mt-6 mb-3 text-gray-900">Roommate Status</h3>
                        {user?.roommateConnections && user.roommateConnections.length > 0 ? (
                            <div className="bg-green-50 border border-green-200 rounded-md p-4">
                                <p className="text-green-800 font-medium mb-2">You have {user.roommateConnections.length} roommate{user.roommateConnections.length > 1 ? 's' : ''}.</p>
                                <p className="text-green-700 text-sm">View details in the Find Roommates section.</p>
                            </div>
                        ) : (
                            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                                <div className="flex items-start">
